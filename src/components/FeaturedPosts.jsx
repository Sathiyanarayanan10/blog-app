  ...
  return (
    <div className="mt-8 flex flex-col lg:flex-row gap-8">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        {/* image */}
        {posts[0].img && <Image
          src={`${import.meta.env.VITE_IK_URL_ENDPOINT}/${posts[0].img}`}
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        ...
        {posts[1] && <div className="lg:h-1/3 flex justify-between gap-4">
          {posts[1].img && <div className="w-1/3 aspect-video">
            <Image
              src={`${import.meta.env.VITE_IK_URL_ENDPOINT}/${posts[1].img}`}
        ...
        {posts[2] && <div className="lg:h-1/3 flex justify-between gap-4">
          {posts[2].img && <div className="w-1/3 aspect-video">
            <Image
              src={`${import.meta.env.VITE_IK_URL_ENDPOINT}/${posts[2].img}`}
              className="rounded-3xl object-fill w-full h-full"
              w="298"
            />
          </div>}
          {/* details and title */}
        ...
        {posts[3] && <div className="lg:h-1/3 flex justify-between gap-4">
          {posts[3].img && <div className="w-1/3 aspect-video">
            <Image
              src={`${import.meta.env.VITE_IK_URL_ENDPOINT}/${posts[3].img}`}
              className="rounded-3xl object-fill w-full h-full"
              w="298"
            />
          </div>}
